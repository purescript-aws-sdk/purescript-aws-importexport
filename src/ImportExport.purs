...
cancelJob = Request.request service method  where
    service = Request.ServiceName "ImportExport"
...
getShippingLabel = Request.request service method  where
    service = Request.ServiceName "ImportExport"
    method = Request.MethodName "getShippingLabel"
...
getStatus = Request.request service method  where
    service = Request.ServiceName "ImportExport"
    method = Request.MethodName "getStatus"
